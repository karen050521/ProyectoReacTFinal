...
const CreatePermissionAdvanced = () => {
  ...
  const renderTailwind = () => (
    <>
      <Breadcrumb pageName="Crear Permiso - Advanced" />
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="border-b border-stroke py-4 px-6.5 dark:border-strokedark">
          <h3 className="font-medium text-black dark:text-white text-xl">
            Permission Create - Advanced Version
          </h3>
          <p className="text-sm text-gray-500 mt-1">Enhanced permission creation with dual UI and better validation</p>
        </div>
    ...
    <>
      ...
      <Paper elevation={3} sx={{ p: 4, maxWidth: 600, mx: "auto" }}>
        <Typography variant="h4" component="h1" fontWeight="bold" mb={1}>
          Permission Create - Advanced
        </Typography>
        <Typography variant="body2" color="text.secondary" mb={3}>
          Enhanced permission creation with dual UI and better validation
        </Typography>
...
export default CreatePermissionAdvanced;
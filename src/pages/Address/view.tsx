  ...
  if (!address) {
    return (
      <>
        <Breadcrumb pageName={userName ? `${userName} - Dirección` : 'Dirección'} />
        <div className="p-6 bg-white rounded-md shadow-md">
          <h2 className="text-xl font-bold mb-4 text-gray-800">No hay dirección registrada</h2>
          <p className="text-gray-600 mb-6">Este usuario no tiene una dirección guardada.</p>
    ...
    <>
      ...
      <div className="p-6">
        ...
        <div className="flex gap-6">
          ...
          <div className="w-1/3 bg-white rounded shadow p-6 flex flex-col gap-4">
            <h2 className="text-xl font-bold text-gray-800 mb-2">Detalles de la Dirección</h2>
            
            <div className="border-b pb-3">
              <label className="block text-sm font-medium text-gray-500 mb-1">Calle</label>
              <p className="text-lg text-gray-800">{address.street || 'N/A'}</p>
            </div>

            <div className="border-b pb-3">
              <label className="block text-sm font-medium text-gray-500 mb-1">Número</label>
              <p className="text-lg text-gray-800">{address.number || 'N/A'}</p>
            </div>

            <div className="border-b pb-3">
              <label className="block text-sm font-medium text-gray-500 mb-1">Latitud</label>
              <p className="text-lg text-gray-800">{address.latitude}</p>
            </div>

            <div className="border-b pb-3">
              <label className="block text-sm font-medium text-gray-500 mb-1">Longitud</label>
              <p className="text-lg text-gray-800">{address.longitude}</p>
            </div>
